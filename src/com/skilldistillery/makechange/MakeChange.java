...
public class MakeChange {
	...
	private static void calcPayment(double price, double payment) {
		...
		if (price < payment) {
			...
			if (counter > 0) {
					System.out.println((counter) + " $" + bill20 + "0 dollar bills");
			}
			...
			if (counter > 0) {
			System.out.println((counter) + " $" + bill10 + "0 dollar bills");
			}
			...
			if (counter > 0) {
			System.out.println(counter + " $" + bill5 + "0 dollar bills");
			}
			...
			if (counter > 0) {
			System.out.println(counter + " $" + bill1 + "0 dollar bills");
			}
			...
			if (counter > 0) {
			System.out.println(counter + " nickles");
			}
